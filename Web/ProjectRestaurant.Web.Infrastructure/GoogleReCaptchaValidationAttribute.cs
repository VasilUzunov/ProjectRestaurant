namespace ProjectRestaurant.Web.Infrastructure
{
    using System;
    ...
    public class GoogleReCaptchaValidationAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (configuration == null || string.IsNullOrWhiteSpace(configuration["ReCaptcha:PrivateKey"]))
            {
                return new ValidationResult(
            ...
            var content = new FormUrlEncodedContent(
                new[]
                    {
                        new KeyValuePair<string, string>("secret", configuration["ReCaptcha:PrivateKey"]),
